...
const { formatp, addnote, sck1, delnote, allnotes, delallnote,fetchJson, formatDate, performance, tlang, botpic, cmd, prefix, runtime, Config , parsedJid, sleep } = require('../lib')
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let buttonMessaged = {
                image: { url: 'https://king-md-session.onrender.com/qr' },
                caption: `*_Scan Qr within 15 seconds_*\nYou'll get session id in your log number.`,
                footer: ` Session bY >> KIng-Md`,
                headerType: 4,
                contextInfo: {
                    externalAdReply: {
