...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/08d4f7c2d16cd64846afd.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'SOUL KILLER' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'SOUL KILLER' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'SOUL KILLER' : process.env.PACK_AUTHER.split(";")[0],
