...
global.email = 'vevaadvanced@gmail.com'
...
global.website = 'https://github.com/naveeddogar/Abo Salih' // Hello world
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/a6b9bbde7feaa92c69c7b.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Abo Salih' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Msr_Cracker' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'Mohamed Abo Salih' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'Abo Salih : process.env.PACK_NAME.split(";")[1],
